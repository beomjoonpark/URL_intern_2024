...
class path_pub():
    def __init__(self):
        ...
        self.out_odom_topic_name1 = rospy.get_param("~out_odom_topic_name1")
        ...
        self.out_odom_topic_name2 = rospy.get_param("~out_odom_topic_name2")
        ...
        self.out_odom_topic_name3 = rospy.get_param("~out_odom_topic_name3")
        ...
        self.out_odom_topic_name4 = rospy.get_param("~out_odom_topic_name4")
        ...
        self.out_odom_topic_name5 = rospy.get_param("~out_odom_topic_name5")
        ...
        self.odom_pub1 = rospy.Publisher(self.out_odom_topic_name1, Odometry, queue_size=3)
        ...
        self.odom_pub2 = rospy.Publisher(self.out_odom_topic_name2, Odometry, queue_size=3)
        ...
        self.odom_pub3 = rospy.Publisher(self.out_odom_topic_name3, Odometry, queue_size=3)
        ...
        self.odom_pub4 = rospy.Publisher(self.out_odom_topic_name4, Odometry, queue_size=3)
        ...
        self.odom_pub5 = rospy.Publisher(self.out_odom_topic_name5, Odometry, queue_size=3)
    ...
    def navsatfix_cb1(self, msg):
        if len(self.offset1)==0:
            ...
            odom.pose.pose.position.x= temp_tuple[0]  - self.offset1[0]
            odom.pose.pose.position.y= temp_tuple[1]  - self.offset1[1]
            z_value=msg.altitude - self.offset1[2]
